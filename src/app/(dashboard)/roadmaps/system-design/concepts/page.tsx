          ...
          {groups.map((group, idx) => (
            ...
            >
              <Link
                ...
                className="flex items-center gap-2 px-3 py-2.5 rounded-lg border border-border bg-card text-muted-foreground hover:bg-accent hover:text-foreground text-left text-sm font-medium transition-all duration-200"
              >
